...
// - prefixing enum arguments with "enum" tag
// - stop function from using default arguments
...
IMGUI_IMPL_API bool     ImGui_ImplSDL2_InitForSDLRenderer(struct SDL_Window* window, struct SDL_Renderer* renderer);
IMGUI_IMPL_API bool     ImGui_ImplSDL2_InitForOther(struct SDL_Window* window);
...
IMGUI_IMPL_API void     ImGui_ImplSDL2_SetGamepadMode(enum ImGui_ImplSDL2_GamepadMode mode, struct _SDL_GameController** manual_gamepads_array, int manual_gamepads_count);
